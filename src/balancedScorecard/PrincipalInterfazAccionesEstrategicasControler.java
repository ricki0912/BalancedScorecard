...
public class PrincipalInterfazAccionesEstrategicasControler extends Funciones implements Initializable {
	...
	public void mostrarObjetivoEstrategicoYAcciones_v2(){
		...
		for(int i=1;i<=4;i++){
			...
			System.out.println("estoy aqui 1");
				...
				tablaAcciones.getJfxButtonNuevo().setVisible((Sesion.ROL==1)?true:false);
				if(Sesion.ROL!=1){
					tablaAcciones.getTablecolumn().setPrefWidth(tablaAcciones.getTablecolumn().getWidth()+tablaAcciones.getTableColumnOpciones().getWidth());;
